...
static char *afl_environment_variables[] = {
    ...
    "AFL_QEMU_TRACK_UNSTABLE", "AFL_QEMU_IJON", "AFL_QUIET",
    "AFL_RANDOM_ALLOC_CANARY", "AFL_REAL_PATH", "AFL_SHA1_FILENAMES",
    ...
    "AFL_USE_MSAN", "AFL_USE_TRACE_PC", "AFL_USE_UBSAN", "AFL_UBSAN_VERBOSE",
    "AFL_USE_TSAN", "AFL_USE_CFISAN", "AFL_CFISAN_VERBOSE", "AFL_USE_LSAN",
    ...
    "AFL_GCC_ONLY_FRSV", "AFL_HYBRID_RATIO", "AFL_SAN_RECOVER",
